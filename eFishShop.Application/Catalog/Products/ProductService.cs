...
using eFishShop.Utilities.Exceptions;
using System;
...
namespace eFishShop.Application.Catalog.Products
{
    public class ProductService : IProductService
    {
        ...
        public async Task<int> Delete(int productId)
        {
            ...
            if (product == null) throw new eFishShopException($"Cannot find a product: {productId}");
        ...
        public async Task<int> Update(ProductUpdateRequest request)
        {
            ...
            if (product == null || productTranslations == null) throw new eFishShopException($"Cannot find a product with id: {request.Id}");
        ...
        {
            var product = await _context.Products.FindAsync(productId);
            if (product == null) throw new eFishShopException($"Cannot find a product with id: {productId}");
