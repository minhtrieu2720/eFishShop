...
namespace eFishShop.Data.Extentions
{
    public static class ModelBuilderExtensions
    {
        public static void Seed(this ModelBuilder modelBuilder)
        {
           ...
           new Product()
           {
            ...
            var roleId = new Guid("7E9C038B-8BC3-4419-9ACF-6424DD3B78D5");
            var adminId = new Guid("9C281D40-55F7-44DD-86E8-58D9EF485428");
            ...
            modelBuilder.Entity<AppUser>().HasData(new AppUser
            {
                ...
                EmailConfirmed = true,
                PasswordHash = hasher.HashPassword(null, "minhtrieu2720"),
                SecurityStamp = string.Empty,
                FirstName = "Nguyen",
                LastName = "Trieu",
                Dob = new DateTime(2021, 01, 21)
            });
