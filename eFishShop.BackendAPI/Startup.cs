...
namespace eFishShop.BackendAPI
{
    public class Startup
    {
        ...
        {
            services.AddDbContext<eFishShopDbContext>(options =>
                options.UseSqlServer(Configuration.GetConnectionString(SystemConstants.MainConnectionString)));

            services.AddIdentity<AppUser, AppRole>()
                .AddEntityFrameworkStores<eFishShopDbContext>()
            ...
            {
                c.SwaggerDoc("v1", new OpenApiInfo { Title = "Swagger eFishShop Solution", Version = "v1" });
